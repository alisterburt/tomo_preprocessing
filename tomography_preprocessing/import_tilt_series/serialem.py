...
def import_tilt_series_from_serial_em(
        ...
        invert_defocus_handedness: Optional[bool] = False,
    ...
    invert_defocus_handedess: Set this to flip the handedness of the tilt geometry (default=1). 
    ...
    #Default defocus handedness is +1
    if invert_defocus_handedness:
        global_df['rlnTomoHand'] = -1
    else:
        global_df['rlnTomoHand'] = 1
